 ...
 */
class RolesPermissions extends \Vlreleases\UserBundle\Entity\RolesPermissions implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\RolesPermissions' . "\0" . 'add', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\RolesPermissions' . "\0" . 'edit', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\RolesPermissions' . "\0" . 'view', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\RolesPermissions' . "\0" . 'id', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\RolesPermissions' . "\0" . 'role', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\RolesPermissions' . "\0" . 'actions');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RolesPermissions $proxy) {
    ...
    public function setActions(\Vlreleases\UserBundle\Entity\Actions $actions = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setActions', array($actions));

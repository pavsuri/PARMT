 ...
 */
class UserCustomSkill extends \Vlreleases\UserBundle\Entity\UserCustomSkill implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\UserCustomSkill' . "\0" . 'skill', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\UserCustomSkill' . "\0" . 'experience');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserCustomSkill $proxy) {

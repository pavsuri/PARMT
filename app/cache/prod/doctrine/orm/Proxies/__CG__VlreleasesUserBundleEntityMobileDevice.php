 ...
 */
class MobileDevice extends \Vlreleases\UserBundle\Entity\MobileDevice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'name', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'version', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'UUID', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'serialNumber', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'createdDate', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'lastModifiedDate', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'active', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'available', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'id', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'deviceStatus', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'requesters', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'assignedUsers', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'os', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'brand', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'project', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDevice' . "\0" . 'createdBy');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MobileDevice $proxy) {

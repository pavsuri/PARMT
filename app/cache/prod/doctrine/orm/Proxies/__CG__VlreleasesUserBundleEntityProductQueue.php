 ...
 */
class ProductQueue extends \Vlreleases\UserBundle\Entity\ProductQueue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\ProductQueue' . "\0" . 'startTime', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\ProductQueue' . "\0" . 'id', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\ProductQueue' . "\0" . 'product', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\ProductQueue' . "\0" . 'requester');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductQueue $proxy) {

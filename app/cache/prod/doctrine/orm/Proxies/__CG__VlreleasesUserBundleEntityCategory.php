 ...
 */
class Category extends \Vlreleases\UserBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\Category' . "\0" . 'active', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\Category' . "\0" . 'available', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\Category' . "\0" . 'createdDate', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\Category' . "\0" . 'lastModifiedDate', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\Category' . "\0" . 'products', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\Category' . "\0" . 'createdBy');
        }

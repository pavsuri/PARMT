 ...
 */
class Client extends \Vlreleases\UserBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = array('clientName' => NULL, 'status' => NULL);
    ...
    {
        unset($this->clientName, $this->status);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'clientName', 'status', 'id');
        }

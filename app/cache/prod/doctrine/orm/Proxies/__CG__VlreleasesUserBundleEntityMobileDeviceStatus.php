 ...
 */
class MobileDeviceStatus extends \Vlreleases\UserBundle\Entity\MobileDeviceStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDeviceStatus' . "\0" . 'startTime', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDeviceStatus' . "\0" . 'expectedEndTime', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDeviceStatus' . "\0" . 'endTime', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDeviceStatus' . "\0" . 'id', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDeviceStatus' . "\0" . 'mobileDevice', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\MobileDeviceStatus' . "\0" . 'assignee');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MobileDeviceStatus $proxy) {
    ...
    public function setMobileDevice(\Vlreleases\UserBundle\Entity\MobileDevice $mobileDevice = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMobileDevice', array($mobileDevice));

        return parent::setMobileDevice($mobileDevice);
    }
    ...
    public function getMobileDevice()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMobileDevice', array());

        return parent::getMobileDevice();
    }

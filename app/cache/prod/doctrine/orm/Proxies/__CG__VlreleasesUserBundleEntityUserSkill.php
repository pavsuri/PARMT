 ...
 */
class UserSkill extends \Vlreleases\UserBundle\Entity\UserSkill implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\UserSkill' . "\0" . 'skill', '' . "\0" . 'Vlreleases\\UserBundle\\Entity\\UserSkill' . "\0" . 'experience');
        }
